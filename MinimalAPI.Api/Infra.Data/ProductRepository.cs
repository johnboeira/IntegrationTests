using eCommerce.MinimalApi.Contracts.Product;

namespace eCommerce.MinimalApi.Infra;
...
public class ProductRepository
{
    ...
    public async Task<ProductResponse> GetByIdAsync(Guid id, HttpContext httpContext)
    {
        await Task.Delay(600, httpContext.RequestAborted); // simulando operação de I/O (Banco)
